...
public class RegressionCarMovement : MonoBehaviour
{
    ...
    public float maxValueMotorTorque; // more than 410, the car can't finish the circuit
    ...
    void Start()
    {
        ...
        /**
         * THE CIRCUIT HAS SOME ERRORS IN ITS DESIGN SO SOME NODES ARE DIFFICULT FOR CARS TO REACH
         * THE WORST PART IS AROUND NODE (22) AND NODE (31)
         */
    }
